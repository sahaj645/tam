...
export default function JoinCodeCortex() {
  ...
  const joinTeam = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/joinCortex', {
        ParticipantName,
        VITEmail,
        RegNo,
        TeamName,
  ...
  return (
    <div style={{ maxWidth: '600px', margin: 'auto', padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '20px' }}><b>JOIN CODE CORTEX TEAM</b></h1>
